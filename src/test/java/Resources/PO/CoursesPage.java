...
public class CoursesPage extends PageFactory {
    public static final String PAGE_HEADER = "Courses";
    ...
    @FindBy(how = How.XPATH, using = "//*[@id=\"block-mainnavigation\"]/ul/li[1]/ul/li[2]/div/a")
    public WebElement coursesDropdownOption;
    ...
    public boolean isDropdownOpened() {
        return programsAndCoursesDropdown.getAttribute("class").contains("open")
                || coursesDropdownOption.isDisplayed();
    }
}
